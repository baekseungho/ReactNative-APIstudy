//touch 이벤트 정보를 가져올 수 있는 API
// 스와이프, 탭, 핕치, 스크롤링, 싱글터치, 멀티터치 등등 조작
...
export default class PanResopn extends Component {
  constructor() {
    //생성자
    super(); // 부모생성자
    this.state = {
    ...
    this._handleMove = this._handleMove.bind(this); // 사각형이 움직인 거리계산용
    this._handleRelease = this._handleRelease.bind(this); // 화면에 업데이트된 위치 저장용

    // PanResponder 객체 생성하여 touch시 사용할 메서드 지정하기
